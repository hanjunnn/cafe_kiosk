...
Swal.fire({
   title: '결제 하시겠습니까?',
   html: orderData+"<br>총 가격: "+ numberWithCommas(total_price)+"원",
   icon: 'warning',
...
<body>
    <div class="container">
        ...
        <div class="overlay-text">COMPOSE COFFEE</div>
    </div>
    <br>
    <div class="categorybar">
        <table>
            <tr>
                <td>
                    <div class="button" onclick='changeMenu(1)'>
                        커피
                    </div>
                </td>
                <td>
                    <div class="button" onclick='changeMenu(2)'>
                        스무디/프라페
                    </div>
                </td>
                <td>
                    <div class="button" onclick='changeMenu(3)'>
                        에이드/주스
                    </div>
                </td>
                <td>
                    <div class="button" onclick='changeMenu(4)'>
                        티
                    </div>
                </td>
            </tr>
